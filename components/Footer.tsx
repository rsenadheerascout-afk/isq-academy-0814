...
export default function Footer() {
    return (
        <footer className="bg-[#1a1a1a] text-white py-16 px-6 border-t-[6px] border-[#00beb2]">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                {/* Discover Courses */}
                <div>
                    <h4 className="text-[#00beb2] font-bold text-xs uppercase tracking-wider mb-4">
                        Discover Courses
                    </h4>
                ...
                <div className="flex flex-col items-start md:items-end">
                    ...
                    <div className="flex space-x-4">
                        <div className="w-6 h-6 rounded-full bg-white text-black flex items-center justify-center font-bold text-xs cursor-pointer hover:bg-[#00beb2] transition-colors">
                            f
                        </div>
                        <div className="w-6 h-6 rounded-full bg-white text-black flex items-center justify-center font-bold text-xs cursor-pointer hover:bg-[#00beb2] transition-colors">
                            in
