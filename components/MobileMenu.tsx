...
import { Category, SubCategory } from "@/data/navigation";
      ...
      <div className="flex flex-col py-2">
        ...
        <div className="border-b border-gray-100">
          ...
          >
            Explore courses
            <span
              className={`transform transition-transform ${isMobileCoursesOpen ? "rotate-180" : ""}`}
            >
              ▼
            </span>
          </button>
        ...
        <div className="px-6 py-6">
          <Link
            ...
            target="_blank"
            className="w-full bg-black text-white px-6 py-3 text-sm hover:bg-primary transition-colors rounded-lg"
          >
            Chat with Us
          </Link>
        </div>
