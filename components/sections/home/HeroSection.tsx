  ...
  return (
    <section className="relative bg-slate-950 text-white py-24 lg:px-40 md:px-20 px-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full lg:w-1/2 pointer-events-none">
        ...
        <Link
          href="/courses"
          className="inline-block bg-primary text-black px-8 py-3 hover:bg-[#fdc806] hover:shadow-[#fdc806] hover:shadow-[0_0_20px_rgba(34,211,238,0.7)] hover:scale-105 transition duration-150 rounded-full pointer-events-auto font-light"
