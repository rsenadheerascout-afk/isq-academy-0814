              ...
              return (
                <div key={i} className="flex items-start gap-7">
                  <div className="relative flex-shrink-0 w-28 h-28 flex items-center justify-center">
                    <div className="absolute inset-0 rounded-full border-[8px] border-[#00beb2] border-r-transparent border-b-transparent -rotate-45"></div>
                    <div className="w-24 h-24 rounded-full bg-[#292727] flex items-center justify-center">
                      <Icon
                        size={42}
                        strokeWidth={1.8}
