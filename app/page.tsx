    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <section className="bg-black text-white py-24 px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <Link
            href="/courses"
            className="inline-block bg-[#00beb2] text-black font-bold px-8 py-3 hover:bg-[#fdc806] transition-colors duration-300"
          >
            Browse courses
          </Link>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 -mt-12 relative z-20 mb-20">
        <div className="bg-gray-200 aspect-video w-full relative flex items-center justify-center cursor-pointer group shadow-2xl border-4 border-white">
          ...
          <div className="flex flex-col items-center z-10">
            ...
            <span className="text-white font-semibold shadow-sm">
              Explore our story
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-left">
          {benefits.map((item, i) => (
            <div key={i} className="flex flex-col items-start">
              ...
              <div className="w-12 h-12 rounded-full bg-[#00beb2] text-white flex items-center justify-center mb-4 text-xl font-bold">
                {i + 1}
              </div>
      ...
      <section className="bg-gray-50 py-20 px-6 border-y border-gray-200">
        <div className="max-w-7xl mx-auto">
            ...
            {featuredCourses.map((course) => (
              ...
              >
                ...
                <div className="p-6 flex-grow flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-4 group-hover:underline decoration-[#00beb2] decoration-2 underline-offset-4">
                      {course.title}
                    </h3>
                  ...
                  <div className="text-sm font-semibold border-t border-gray-100 pt-4">
                    Next course:{' '}
          ...
          <div className="mt-12 text-center">
            <Link
              href="/courses"
              className="inline-block bg-black text-white px-8 py-3 font-semibold hover:bg-[#00beb2] transition-colors"
            >
              View all courses
            </Link>
          </div>
      ...
      >
        <div className="border border-gray-200 flex flex-col md:flex-row">
          ...
          <div className="p-10 md:w-1/2 flex flex-col justify-center">
            ...
            <a
              href="#"
              className="border-2 border-black px-6 py-2 text-sm font-bold w-max hover:bg-black hover:text-white transition-colors"
            >
              Read more
            </a>
          ...
          <div className="md:w-1/2 bg-gray-100 flex items-center justify-center min-h-[250px]">
            <span className="text-4xl font-bold tracking-widest text-gray-300">
              iSeeQ
            </span>
          </div>
      ...
      >
        ...
        <form className="text-left space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-black text-white font-bold py-3 mt-4 hover:bg-[#00beb2] transition-colors"
          >
            Sign up
          </button>
