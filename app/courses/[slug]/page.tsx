...
export default function SingleCoursePage() {
  ...
  return (
    <main className="min-h-screen bg-white font-montserrat font-sans font-normal">
      <Breadcrumbs />
      {/* Hero Section */}
      <section className="relative w-full h-[450px] bg-gray-900 flex items-center">
        ...
        <div className="relative z-10 max-w-5xl px-4 md:px-8 text-white">
          <div className="bg-white/90 backdrop-blur-sm text-black p-8 md:p-12 max-w-2xl inline-block shadow-lg">
            <h1 className="text-3xl md:text-5xl mb-4 tracking-tight">
      ...
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200 px-4 md:px-8 py-3 flex justify-between items-center shadow-sm">
        ...
        <button className="border-2 border-black px-6 py-2 text-sm hover:bg-black hover:text-white transition-colors">
          Course brochure
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 space-y-20">
        ...
        <section id="key-info" className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="border border-gray-200 p-6">
              ...
              <p className="text-xl">US$2,970 - US$3,150</p>
            </div>
            <div className="border border-gray-200 p-6">
            ...
            <div className="border border-gray-200 p-6">
              ...
              <p className="text-xl">6-8 hours per week</p>
            </div>
            <div className="border border-gray-200 p-6">
              <p className="text-sm text-gray-500 mb-1">Study mode</p>
              <p className="text-xl">Tutor guided / online</p>
            </div>
          </div>
          <div className="lg:col-span-1 flex flex-col space-y-4">
            <button className="w-full bg-black text-white py-4 hover:bg-gray-800 transition-colors shadow-md">
              Download Brochure
            </button>
            <button className="w-full border-2 border-black text-black py-4 hover:bg-gray-50 transition-colors">
              Request a call
            </button>
          </div>
        </section>
        ...
        <section id="about" className="max-w-4xl">
          <h2 className="text-3xl mb-8 text-gray-900">About the course</h2>
          <CourseAccordion items={courseSections} />
        </section>

        {/* Academic Staff / Lead */}
        <section id="lead" className="max-w-4xl">
          <h2 className="text-3xl mb-8 text-gray-900">Academic staff</h2>
          <div className="border border-gray-200 p-8 flex flex-col sm:flex-row items-start sm:space-x-8 bg-white">
            ...
            <div>
              <h3 className="text-xl text-black border-b border-black inline-block mb-2">
        ...
        <section id="testimonials">
          <h2 className="text-3xl mb-8 text-gray-900">What our learners are saying</h2>
          <Testimonials />
        </section>

        {/* Related Context */}
        <section id="related-courses" className="pt-8 border-t border-gray-200">
          <h2 className="text-2xl mb-6 text-gray-900">Related context</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-100 aspect-video flex items-end p-6 relative overflow-hidden group">
              ...
              <h3 className="relative z-10 text-white text-lg max-w-xs">
                Why must organizations transition to sustainable practices?
              </h3>
            </div>
            <div className="bg-gray-100 aspect-video flex items-end p-6 relative overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-black/30"></div>
              <h3 className="relative z-10 text-white text-lg max-w-xs">
                What form does climate misinformation take?
              </h3>
            </div>
          </div>
        </section>
